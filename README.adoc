...
.. Toujours dans "_Paramètres → Général_", enregistrez ceci comme description du projet : `projet-idl-2023-bTSeydUgj`. 
...
*Seulement si cette situation se produit*, vous pourrez récupérer les corrections effectuées par les enseignants à l'aide des commandes suivantes :
